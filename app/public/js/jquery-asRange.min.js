...
! function (t, e) {
    ...
    function s(t) {
        ...
        if ("string" == typeof t) {
            ...
            if (!(/^(get)$/.test(a) || "val" === a && 0 === i.length)) return this.each(function () {
        ...
        return this.each(function () {
            (0, n.default)(this).data(v) || (0, n.default)(this).data(v, new d(this, t))
        })
    }
    var n = function (t) {
        ...
        u = function () {
            function t(i, s, a) {
                e(this, t), this.$element = i, this.uid = s, this.parent = a, this.options = n.default.extend(!0, {}, this.parent.options), this.direction = this.options.direction, this.value = null, this.classes = {
            ...
            return o(t, [{
                ...
                value: function (t) {
                    ...
                    this.$element.trigger(this.parent.namespace + "::moveStart", this), this.data = {}, this.data.start = t[e], this.data.position = t[e] - a[s];
                    ...
                    return this.set(o), n.default.each(this.parent.pointer, function (t, e) {
                        ...
                        var s = i(t),
                            n = this.parent.getValueFromPosition(this.data.position + (s[e] || this.data.start) - this.data.start);
        ...
        l = {
            ...
            init: function (t) {
                var e = n.default.extend({}, this.defaults, t.options.scale).scale;
                e.values = [], e.values.push(t.min);
                for (var i = (t.max - t.min) / (e.valuesNumber - 1), s = 1; s <= e.valuesNumber - 2; s++) e.values.push(i * s);
                e.values.push(t.max);
                var a = {
                    ...
                    u = 100 / (r - 1),
                    l = 100 / (o - 1);
                this.$scale = (0, n.default)("<div></div>").addClass(a.scale), this.$lines = (0, n.default)("<ul></ul>").addClass(a.lines), this.$values = (0, n.default)("<ul></ul>").addClass(a.values);
                for (var h = 0; h < r; h++) {
                    (0 === h || h === r || h % ((r - 1) / (o - 1)) == 0 ? (0, n.default)('<li class="' + a.grid + '"></li>') : h % e.grid == 0 ? (0, n.default)('<li class="' + a.inlineGrid + '"></li>') : (0, n.default)("<li></li>")).css({
                        left: u * h + "%"
                    }).appendTo(this.$lines)
                }
                for (var p = 0; p < o; p++)(0, n.default)("<li><span>" + e.values[p] + "</span></li>").css({
                    left: l * p + "%"
        ...
        h = {
            ...
            init: function (t) {
                var e = this;
                if (this.$arrow = (0, n.default)("<span></span>").appendTo(t.$wrap), this.$arrow.addClass(t.namespace + "-selected"), !1 === t.options.range && t.p1.$element.on(t.namespace + "::move", function (t, i) {
                        e.$arrow.css({
                            left: 0,
                            width: i.getPercent() + "%"
                        })
        ...
        p = {
            ...
            init: function (t) {
                var e = this,
                    i = n.default.extend({}, this.defaults, t.options.tip);
                this.opts = i, this.classes = {
                    ...
                    o.addClass(e.classes.tip), "onMove" === e.opts.active && (o.css({
                        display: "none"
                    }), s.$element.on(t.namespace + "::moveEnd", function () {
                        return e.hide(o), !1
                    }).on(t.namespace + "::moveStart", function () {
                        return e.show(o), !1
                    })), s.$element.on(t.namespace + "::move", function () {
                        var e = void 0;
                        if (e = t.options.range ? t.get()[i] : t.get(), "function" == typeof t.options.format)
                            if (t.options.replaceFirst && "number" != typeof e) {
                                if ("string" == typeof t.options.replaceFirst && (e = t.options.replaceFirst), "object" === a(t.options.replaceFirst))
                                    for (var s in t.options.replaceFirst) Object.hasOwnProperty(t.options.replaceFirst, s) && (e = t.options.replaceFirst[s])
        ...
        d = function () {
            function t(i, s) {
                ...
                if (this.element = i, this.$element = (0, n.default)(i), this.$element.is("input")) {
                    ...
                    "string" == typeof u && (o.value = u.split(",")), n.default.each(["min", "max", "step"], function (t, e) {
                        ...
                        display: "none"
                    }), this.$wrap = (0, n.default)("<div></div>"), this.$element.after(this.$wrap)
                } else this.$wrap = this.$element;
                if (this.options = n.default.extend({}, r, s, this.$element.data(), o), this.namespace = this.options.namespace, this.components = n.default.extend(!0, {}, c), this.options.range && (this.options.replaceFirst = !1), this.value = this.options.value, null === this.value && (this.value = this.options.min), this.options.range ? n.default.isArray(this.value) ? 1 === this.value.length && (this.value[1] = this.value[0]) : this.value = [this.value, this.value] : n.default.isArray(this.value) && (this.value = this.value[0]), this.min = this.options.min, this.max = this.options.max, this.step = this.options.step, this.interval = this.max - this.min, this.initialized = !1, this.updating = !1, this.disabled = !1, "v" === this.options.direction ? this.direction = {
                        axis: "pageY",
                        position: "top"
                    } : this.direction = {
                        axis: "pageX",
            ...
            return o(t, [{
                ...
                value: function () {
                    ...
                    for (var e = 1; e <= t; e++) {
                        var i = (0, n.default)('<div class="' + this.namespace + "-pointer " + this.namespace + "-pointer-" + e + '"></div>').appendTo(this.$wrap),
                            s = new u(i, e, this);
                        this.pointer.push(s)
                    }
                ...
                value: function () {
                    ...
                    this.$wrap.on("touchstart.asRange mousedown.asRange", function (t) {
                        if (!0 !== e.disabled) {
                            ...
                            var s = e.$wrap.offset(),
                                n = t[e.direction.axis] - s[e.direction.position];
                ...
                value: function () {
                    ...
                    if (t[0] === this.options.min && ("string" == typeof this.options.replaceFirst && (t[0] = this.options.replaceFirst), "object" === a(this.options.replaceFirst)))
    ...
    d.registerComponent("scale", l), d.registerComponent("selected", h), d.registerComponent("tip", p),
        function () {
            ...
            t.on("asRange::ready", function (e, i) {
                var s = void 0,
                    a = {
                        ...
                        attach: function (e) {
                            var i = void 0,
                                s = void 0;
                            for (i in e) e.hasOwnProperty(i) && ((s = i.toUpperCase()) in a.keys ? a.map[a.keys[s]] = e[i] : a.map[s] = e[i]);
                ...
                !0 === i.options.keyboard && n.default.each(i.pointer, function (t, e) {
    ...
    var f = {
        ...
        v = "asRange",
        m = n.default.fn.asRange;
    n.default.fn.asRange = s, n.default.asRange = n.default.extend({
        setDefaults: d.setDefaults,
        noConflict: function () {
            return n.default.fn.asRange = m, s
        }
    }, f)
});
